...
import './SkillBar.css';
import * as mageSkills from '../../../../skills/mage/index.js';
import * as warlockSkills from '../../../../skills/warlock/index.js';
import * as paladinSkills from '../../../../skills/paladin/index.js';
import * as rogueSkills from '../../../../skills/rogue/index.js';
import * as warriorSkills from '../../../../skills/warrior/index.js';
...
export const SkillBar = ({ mana = 0, level = 1, skillPoints = 0, learnedSkills = {} }) => {
    ...
    let skills = MAGE_SKILLS;
    if (character?.class === 'warlock') skills = WARLOCK_SKILLS;
    else if (character?.class === 'paladin') skills = PALADIN_SKILLS;
    else if (character?.class === 'rogue') skills = ROGUE_SKILLS;
    else if (character?.class === 'warrior') skills = WARRIOR_SKILLS;
